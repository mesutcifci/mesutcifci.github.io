...
import Store from "./Pages/LearnArea/Store";
import { List } from "./Pages/LearnArea/List";
        ...
        <Router>
          ...
          <AnimatePresence>
            <Routes>
              ...
              <Route path={"/learn-page"} exact element={<List />} />
              <Route path={"/learn-page/:id"} exact element={<Store />} />
            </Routes>
          </AnimatePresence>
          <Footer />
        </Router>
